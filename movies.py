...
with outer_col[0]:
    ...
    st.markdown("<p align='center'><a href='https://streamable.com/k0o4gg' target='_blank'><img width='400' class = 'center' src='https://raw.githubusercontent.com/PeliculasEnASL/Peliculas/main/images/puberty.jpg'></a></p>", unsafe_allow_html=True)
    st.markdown("<a href='https://streamable.com/qi4hv1' target='_blank'><img width='200' class = 'center' src='https://raw.githubusercontent.com/PeliculasEnASL/Peliculas/main/images/InsideOut.jpg'></a>", unsafe_allow_html=True)
...
with outer_col[1]:
    ...
    st.markdown("<a href='https://streamable.com/57m202' target='_blank'><img width='200' src='https://raw.githubusercontent.com/PeliculasEnASL/Peliculas/main/images/Toy_Story.jpg'></a>", unsafe_allow_html=True)
