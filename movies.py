...
with outer_col[0]:
    ...
    st.markdown("<a href='https://streamable.com/k0o4gg' target='_blank'><img width='200' src='https://raw.githubusercontent.com/PeliculasEnASL/Peliculas/main/images/TheSantaClause.jpeg'></a>", unsafe_allow_html=True)
...
with outer_col[1]:
    ...
    st.markdown("<a href='https://streamable.com/e/7949vm?' target='_blank'><img width='200' src='https://github.com/PeliculasEnASL/Peliculas/main/images/puberty.jpg'></a>", unsafe_allow_html=True)
